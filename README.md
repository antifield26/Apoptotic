...
- **协议**: Minecraft 26.2 (protocol 776), 72 S2C + 37 C2S Play packet handler 分支
...
- **配方**: 1534/~1700 (90%), 部分特殊配方 (旗帜图案/烟花/染色) 未实现
- **C2S 处理器**: 37/54 (69%), 25 完整 + 12 stub, 缺失 JigsawGenerate/StructureBlock/CommandBlock/ChunkBatchResponse 等
- **效果**: 21/33 连线 (64%), Speed/Slowness/JumpBoost/MiningFatigue 已连线, 纯客户端视觉/NPC 效果未连线
- **实体 AI**: ~60/96 (63%), 约 20 种仅通用漫游/游泳, 部分 AI 为简化实现
- **实体 ID**: 自定义范围 111-131 非官方 vanilla ID, 需与 26.2 entities.json 核对
