...
- **协议**: Minecraft 26.2 "Chaos Cubed" (protocol 776)，70+ S2C + 40+ C2S Play 包处理器（包 ID 已对齐官方 protocol.json，12 已提取至 c2s_handlers.rs）
- **区块**: level_chunk_with_light + chunks_biomes + batch_start/finished 协议
