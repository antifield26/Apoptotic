    ...
    fn execute(&self, ctx: &CommandContext) -> CommandResult {
        ...
        if let Some(mm) = ctx.mob_manager {
            ...
            let mob = mc_player::mob::TrackedMob {
                ...
                owner_uuid: None, is_tamed: false, is_sitting: false, tame_attempts: 0, is_baby: false, in_love_ticks: 0, breed_cooldown: 0, is_sheared: false, is_on_fire: false, is_in_water: false, path: Vec::new(), path_last_tick: 0, sulfur_cube_archetype: None, absorbed_block_id: None, is_small_cube: false, dirty_flags: 3,
            };
            mm.register(mob);
