...
static ITEM_REGISTRY: LazyLock<HashMap<&'static str, u32>> = LazyLock::new(|| {
    ...
    m.insert("stripped_oak_log", 45);
    m.insert("stripped_spruce_log", 46);
    m.insert("stripped_birch_log", 47);
    m.insert("stripped_jungle_log", 48);
    m.insert("stripped_acacia_log", 49);
    m.insert("stripped_cherry_log", 50);
    m.insert("stripped_dark_oak_log", 51);
    m.insert("stripped_mangrove_log", 52);
    m.insert("stripped_bamboo_block", 53);
    m.insert("stripped_crimson_stem", 54);
    m.insert("stripped_warped_stem", 55);
    ...
    m.insert("packed_ice", 137);
    m.insert("melon", 138);
    m.insert("pumpkin_stem", 139);
    m.insert("melon_stem", 140);
    m.insert("vine", 141);
    m.insert("glow_lichen", 142);
    m.insert("oak_fence_gate", 143);
    m.insert("brick_stairs", 144);
    m.insert("stone_brick_stairs", 145);
    m.insert("mycelium", 146);
    m.insert("lily_pad", 147);
    m.insert("nether_bricks", 148);
    m.insert("nether_brick_fence", 149);
    m.insert("nether_brick_stairs", 150);
    ...
    m.insert("sandstone_stairs", 156);
    m.insert("ender_chest", 157);
    m.insert("emerald_ore", 158);
    m.insert("deepslate_emerald_ore", 159);
    m.insert("emerald_block", 160);
    m.insert("spruce_stairs", 161);
    m.insert("birch_stairs", 162);
    m.insert("jungle_stairs", 163);
    m.insert("crimson_stairs", 164);
    m.insert("warped_stairs", 165);
    m.insert("command_block", 166);
    m.insert("beacon", 167);
    m.insert("cobblestone_wall", 168);
    m.insert("mossy_cobblestone_wall", 169);
    m.insert("anvil", 170);
    m.insert("chipped_anvil", 171);
    m.insert("damaged_anvil", 172);
    ...
    m.insert("white_carpet", 180);
    m.insert("terracotta", 181);
    m.insert("coal_block", 182);
    m.insert("packed_mud", 183);
    m.insert("mud_bricks", 184);
    m.insert("redstone_block", 185);
    m.insert("quartz_block", 186);
    m.insert("quartz_stairs", 187);
    m.insert("oak_stairs", 188);
    ...
    m.insert("shulker_box", 213);
    m.insert("white_shulker_box", 214);
    m.insert("orange_shulker_box", 215);
    m.insert("magenta_shulker_box", 216);
    m.insert("light_blue_shulker_box", 217);
    m.insert("yellow_shulker_box", 218);
    m.insert("lime_shulker_box", 219);
    m.insert("pink_shulker_box", 220);
    m.insert("gray_shulker_box", 221);
    m.insert("light_gray_shulker_box", 222);
    m.insert("cyan_shulker_box", 223);
    m.insert("purple_shulker_box", 224);
    m.insert("blue_shulker_box", 225);
    m.insert("brown_shulker_box", 226);
    m.insert("green_shulker_box", 227);
    m.insert("red_shulker_box", 228);
    m.insert("black_shulker_box", 229);
    m.insert("white_glazed_terracotta", 230);
    m.insert("orange_glazed_terracotta", 231);
    m.insert("magenta_glazed_terracotta", 232);
    m.insert("light_blue_glazed_terracotta", 233);
    m.insert("yellow_glazed_terracotta", 234);
    m.insert("lime_glazed_terracotta", 235);
    m.insert("pink_glazed_terracotta", 236);
    m.insert("gray_glazed_terracotta", 237);
    m.insert("light_gray_glazed_terracotta", 238);
    m.insert("cyan_glazed_terracotta", 239);
    m.insert("purple_glazed_terracotta", 240);
    m.insert("blue_glazed_terracotta", 241);
    m.insert("brown_glazed_terracotta", 242);
    m.insert("green_glazed_terracotta", 243);
    m.insert("red_glazed_terracotta", 244);
    m.insert("black_glazed_terracotta", 245);
    ...
    m.insert("scaffolding", 288);
    m.insert("loom", 289);
    m.insert("barrel", 290);
    m.insert("smoker", 291);
    m.insert("blast_furnace", 292);
    m.insert("cartography_table", 293);
    m.insert("fletching_table", 294);
    m.insert("smithing_table", 295);
    m.insert("grindstone", 296);
    m.insert("stonecutter", 297);
    m.insert("bell", 298);
    m.insert("lantern", 299);
    m.insert("soul_lantern", 300);
    m.insert("campfire", 301);
    m.insert("soul_campfire", 302);
    m.insert("chain", 303);
    m.insert("composter", 304);
    m.insert("beehive", 305);
    m.insert("bee_nest", 306);
    m.insert("honeycomb_block", 307);
    m.insert("honey_block", 308);
    m.insert("lodestone", 309);
    m.insert("crying_obsidian", 310);
    m.insert("respawn_anchor", 311);
    ...
    m.insert("amethyst_block", 330);
    m.insert("budding_amethyst", 331);
    m.insert("calcite", 332);
    m.insert("tuff", 333);
    m.insert("dripstone_block", 334);
    m.insert("pointed_dripstone", 335);
    m.insert("moss_block", 336);
    m.insert("moss_carpet", 337);
    ...
    m.insert("mud", 345);
    m.insert("mangrove_roots", 346);
    m.insert("muddy_mangrove_roots", 347);
    m.insert("raw_iron_block", 348);
    m.insert("raw_copper_block", 349);
    m.insert("raw_gold_block", 350);
    m.insert("sculk", 351);
    m.insert("sculk_catalyst", 352);
    m.insert("sculk_shrieker", 353);
    ...
    m.insert("decorated_pot", 363);
    m.insert("crafter", 364);
    m.insert("trial_spawner", 365);
    m.insert("vault", 366);
    ...
    m.insert("copper_door", 388); m.insert("exposed_copper_door", 389);
    m.insert("weathered_copper_door", 390); m.insert("oxidized_copper_door", 391);
    m.insert("copper_trapdoor", 392); m.insert("exposed_copper_trapdoor", 393);
    m.insert("weathered_copper_trapdoor", 394); m.insert("oxidized_copper_trapdoor", 395);
    m.insert("copper_grate", 396); m.insert("exposed_copper_grate", 397);
    m.insert("weathered_copper_grate", 398); m.insert("oxidized_copper_grate", 399);
    m.insert("copper_bulb", 400); m.insert("exposed_copper_bulb", 401);
    m.insert("weathered_copper_bulb", 402); m.insert("oxidized_copper_bulb", 403);
    // Waxed copper variants
    m.insert("waxed_copper_block", 404); m.insert("waxed_exposed_copper", 405);
    m.insert("waxed_weathered_copper", 406); m.insert("waxed_oxidized_copper", 407);
    m.insert("waxed_cut_copper", 408); m.insert("waxed_exposed_cut_copper", 409);
    m.insert("waxed_weathered_cut_copper", 410); m.insert("waxed_oxidized_cut_copper", 411);
    m.insert("waxed_chiseled_copper", 412);
    m.insert("waxed_copper_door", 413); m.insert("waxed_exposed_copper_door", 414);
    m.insert("waxed_weathered_copper_door", 415); m.insert("waxed_oxidized_copper_door", 416);
    m.insert("waxed_copper_trapdoor", 417); m.insert("waxed_exposed_copper_trapdoor", 418);
    m.insert("waxed_weathered_copper_trapdoor", 419); m.insert("waxed_oxidized_copper_trapdoor", 420);
    m.insert("waxed_copper_grate", 421); m.insert("waxed_exposed_copper_grate", 422);
    m.insert("waxed_weathered_copper_grate", 423); m.insert("waxed_oxidized_copper_grate", 424);
    m.insert("waxed_copper_bulb", 425); m.insert("waxed_exposed_copper_bulb", 426);
    m.insert("waxed_weathered_copper_bulb", 427); m.insert("waxed_oxidized_copper_bulb", 428);
    // 1.21 blocks
    m.insert("chiseled_bookshelf", 429);
    ...
    m.insert("oak_stairs", 430); m.insert("oak_slab", 431);
    m.insert("oak_fence", 432); m.insert("oak_fence_gate", 433);
    m.insert("oak_door", 434); m.insert("oak_trapdoor", 435);
    m.insert("oak_button", 436); m.insert("oak_pressure_plate", 437);
    m.insert("oak_sign", 438); m.insert("oak_hanging_sign", 439);
    m.insert("oak_boat", 440); m.insert("oak_chest_boat", 441);
    m.insert("stripped_oak_log", 442); m.insert("stripped_oak_wood", 443);
    // Spruce variants (450-465)
    m.insert("spruce_stairs", 450); m.insert("spruce_slab", 451);
    m.insert("spruce_fence", 452); m.insert("spruce_fence_gate", 453);
    m.insert("spruce_door", 454); m.insert("spruce_trapdoor", 455);
    m.insert("spruce_button", 456); m.insert("spruce_pressure_plate", 457);
    m.insert("spruce_sign", 458); m.insert("spruce_hanging_sign", 459);
    m.insert("spruce_boat", 460); m.insert("spruce_chest_boat", 461);
    m.insert("stripped_spruce_log", 462); m.insert("stripped_spruce_wood", 463);
    // Birch variants (470-485)
    m.insert("birch_stairs", 470); m.insert("birch_slab", 471);
    m.insert("birch_fence", 472); m.insert("birch_fence_gate", 473);
    m.insert("birch_door", 474); m.insert("birch_trapdoor", 475);
    m.insert("birch_button", 476); m.insert("birch_pressure_plate", 477);
    m.insert("birch_sign", 478); m.insert("birch_hanging_sign", 479);
    m.insert("stripped_birch_log", 480); m.insert("stripped_birch_wood", 481);
    // Jungle variants (490-505)
    m.insert("jungle_stairs", 490); m.insert("jungle_slab", 491);
    m.insert("jungle_fence", 492); m.insert("jungle_fence_gate", 493);
    m.insert("jungle_door", 494); m.insert("jungle_trapdoor", 495);
    m.insert("jungle_button", 496); m.insert("jungle_pressure_plate", 497);
    m.insert("jungle_sign", 498); m.insert("jungle_hanging_sign", 499);
    m.insert("stripped_jungle_log", 500); m.insert("stripped_jungle_wood", 501);
    // Acacia variants (510-525)
    m.insert("acacia_stairs", 510); m.insert("acacia_slab", 511);
    m.insert("acacia_fence", 512); m.insert("acacia_fence_gate", 513);
    m.insert("acacia_door", 514); m.insert("acacia_trapdoor", 515);
    m.insert("acacia_button", 516); m.insert("acacia_pressure_plate", 517);
    m.insert("acacia_sign", 518); m.insert("acacia_hanging_sign", 519);
    m.insert("stripped_acacia_log", 520); m.insert("stripped_acacia_wood", 521);
    // Dark Oak variants (530-545)
    m.insert("dark_oak_stairs", 530); m.insert("dark_oak_slab", 531);
    m.insert("dark_oak_fence", 532); m.insert("dark_oak_fence_gate", 533);
    m.insert("dark_oak_door", 534); m.insert("dark_oak_trapdoor", 535);
    m.insert("dark_oak_button", 536); m.insert("dark_oak_pressure_plate", 537);
    m.insert("dark_oak_sign", 538); m.insert("dark_oak_hanging_sign", 539);
    m.insert("stripped_dark_oak_log", 540); m.insert("stripped_dark_oak_wood", 541);
    // Mangrove variants (550-565)
    m.insert("mangrove_stairs", 550); m.insert("mangrove_slab", 551);
    m.insert("mangrove_fence", 552); m.insert("mangrove_fence_gate", 553);
    m.insert("mangrove_door", 554); m.insert("mangrove_trapdoor", 555);
    m.insert("mangrove_button", 556); m.insert("mangrove_pressure_plate", 557);
    m.insert("mangrove_sign", 558); m.insert("mangrove_hanging_sign", 559);
    m.insert("stripped_mangrove_log", 560); m.insert("stripped_mangrove_wood", 561);
    // Cherry variants (570-585)
    m.insert("cherry_stairs", 570); m.insert("cherry_slab", 571);
    m.insert("cherry_fence", 572); m.insert("cherry_fence_gate", 573);
    m.insert("cherry_door", 574); m.insert("cherry_trapdoor", 575);
    m.insert("cherry_button", 576); m.insert("cherry_pressure_plate", 577);
    m.insert("cherry_sign", 578); m.insert("cherry_hanging_sign", 579);
    m.insert("stripped_cherry_log", 580); m.insert("stripped_cherry_wood", 581);
    // Bamboo variants (590-605)
    m.insert("bamboo_stairs", 590); m.insert("bamboo_slab", 591);
    m.insert("bamboo_fence", 592); m.insert("bamboo_fence_gate", 593);
    m.insert("bamboo_door", 594); m.insert("bamboo_trapdoor", 595);
    m.insert("bamboo_button", 596); m.insert("bamboo_pressure_plate", 597);
    m.insert("bamboo_sign", 598); m.insert("bamboo_hanging_sign", 599);
    m.insert("bamboo_raft", 600); m.insert("bamboo_chest_raft", 601);
    m.insert("stripped_bamboo_block", 602);
    // Crimson + Warped variants (610-635)
    m.insert("crimson_stairs", 610); m.insert("crimson_slab", 611);
    m.insert("crimson_fence", 612); m.insert("crimson_fence_gate", 613);
    m.insert("crimson_door", 614); m.insert("crimson_trapdoor", 615);
    m.insert("crimson_button", 616); m.insert("crimson_pressure_plate", 617);
    m.insert("crimson_sign", 618); m.insert("crimson_hanging_sign", 619);
    m.insert("stripped_crimson_stem", 620); m.insert("stripped_crimson_hyphae", 621);
    m.insert("warped_stairs", 622); m.insert("warped_slab", 623);
    m.insert("warped_fence", 624); m.insert("warped_fence_gate", 625);
    m.insert("warped_door", 626); m.insert("warped_trapdoor", 627);
    m.insert("warped_button", 628); m.insert("warped_pressure_plate", 629);
    m.insert("warped_sign", 630); m.insert("warped_hanging_sign", 631);
    m.insert("stripped_warped_stem", 632); m.insert("stripped_warped_hyphae", 633);
    // Stone + deepslate + nether variants (640-680)
    m.insert("stone_stairs", 640); m.insert("stone_slab", 641);
    m.insert("stone_brick_stairs", 642); m.insert("stone_brick_slab", 643); m.insert("stone_brick_wall", 644);
    m.insert("cobblestone_stairs", 645); m.insert("cobblestone_slab", 646); m.insert("cobblestone_wall", 647);
    m.insert("mossy_cobblestone_stairs", 648); m.insert("mossy_cobblestone_slab", 649); m.insert("mossy_cobblestone_wall", 650);
    m.insert("mossy_stone_brick_stairs", 651); m.insert("mossy_stone_brick_slab", 652); m.insert("mossy_stone_brick_wall", 653);
    m.insert("andesite_stairs", 654); m.insert("andesite_slab", 655); m.insert("andesite_wall", 656);
    m.insert("polished_andesite_stairs", 657); m.insert("polished_andesite_slab", 658);
    m.insert("diorite_stairs", 659); m.insert("diorite_slab", 660); m.insert("diorite_wall", 661);
    m.insert("polished_diorite_stairs", 662); m.insert("polished_diorite_slab", 663);
    m.insert("granite_stairs", 664); m.insert("granite_slab", 665); m.insert("granite_wall", 666);
    m.insert("polished_granite_stairs", 667); m.insert("polished_granite_slab", 668);
    m.insert("deepslate_brick_stairs", 669); m.insert("deepslate_brick_slab", 670); m.insert("deepslate_brick_wall", 671);
    m.insert("deepslate_tile_stairs", 672); m.insert("deepslate_tile_slab", 673); m.insert("deepslate_tile_wall", 674);
    m.insert("polished_deepslate_stairs", 675); m.insert("polished_deepslate_slab", 676); m.insert("polished_deepslate_wall", 677);
    m.insert("cobbled_deepslate_stairs", 678); m.insert("cobbled_deepslate_slab", 679); m.insert("cobbled_deepslate_wall", 680);
    // Nether brick + quartz + sandstone variants (681-710)
    m.insert("nether_brick_stairs", 681); m.insert("nether_brick_slab", 682); m.insert("nether_brick_wall", 683);
    m.insert("red_nether_brick_stairs", 684); m.insert("red_nether_brick_slab", 685); m.insert("red_nether_brick_wall", 686);
    m.insert("quartz_stairs", 687); m.insert("quartz_slab", 688);
    m.insert("smooth_quartz_stairs", 689); m.insert("smooth_quartz_slab", 690);
    m.insert("sandstone_stairs", 691); m.insert("sandstone_slab", 692); m.insert("sandstone_wall", 693);
    m.insert("smooth_sandstone_stairs", 694); m.insert("smooth_sandstone_slab", 695);
    m.insert("red_sandstone_stairs", 696); m.insert("red_sandstone_slab", 697); m.insert("red_sandstone_wall", 698);
    m.insert("smooth_red_sandstone_stairs", 699); m.insert("smooth_red_sandstone_slab", 700);
    m.insert("prismarine_stairs", 701); m.insert("prismarine_slab", 702); m.insert("prismarine_wall", 703);
    m.insert("prismarine_brick_stairs", 704); m.insert("prismarine_brick_slab", 705);
    m.insert("dark_prismarine_stairs", 706); m.insert("dark_prismarine_slab", 707);
    m.insert("blackstone_stairs", 708); m.insert("blackstone_slab", 709); m.insert("blackstone_wall", 710);
    m.insert("polished_blackstone_stairs", 711); m.insert("polished_blackstone_slab", 712); m.insert("polished_blackstone_wall", 713);
    m.insert("polished_blackstone_brick_stairs", 714); m.insert("polished_blackstone_brick_slab", 715); m.insert("polished_blackstone_brick_wall", 716);
    // Functional blocks (831-850)
    m.insert("chipped_anvil", 831); m.insert("damaged_anvil", 832);
    m.insert("composter", 833);
    m.insert("grindstone", 834);
    m.insert("smithing_table", 835);
    m.insert("fletching_table", 836);
    m.insert("cartography_table", 837);
    m.insert("loom", 838);
    m.insert("stonecutter", 839);
    m.insert("bell", 840);
    m.insert("lantern", 841); m.insert("soul_lantern", 842);
    m.insert("chain", 843);
    m.insert("scaffolding", 844);
    m.insert("small_dripleaf", 845); m.insert("big_dripleaf", 846);
    m.insert("pointed_dripstone", 847);
    m.insert("small_amethyst_bud", 848); m.insert("medium_amethyst_bud", 849);
    m.insert("large_amethyst_bud", 850); m.insert("amethyst_cluster", 851);
    m.insert("sniffer_egg", 852);
    ...
    m.insert("enchanted_book", 891);
    m.insert("name_tag", 892);
    m.insert("saddle", 893);
    m.insert("lead", 894);
    m.insert("armor_stand", 895);
    m.insert("item_frame", 896);
    m.insert("glow_item_frame", 897);
    ...
    m.insert("white_candle", 1061); m.insert("orange_candle", 1062); m.insert("magenta_candle", 1063);
    m.insert("light_blue_candle", 1064); m.insert("yellow_candle", 1065); m.insert("lime_candle", 1066);
    m.insert("pink_candle", 1067); m.insert("gray_candle", 1068); m.insert("light_gray_candle", 1069);
    m.insert("cyan_candle", 1070); m.insert("purple_candle", 1071); m.insert("blue_candle", 1072);
    m.insert("brown_candle", 1073); m.insert("green_candle", 1074); m.insert("red_candle", 1075);
    m.insert("black_candle", 1076);
    // Shulker boxes (16 colored + undyed)
    m.insert("shulker_box", 1077);
    m.insert("white_shulker_box", 1078); m.insert("orange_shulker_box", 1079); m.insert("magenta_shulker_box", 1080);
    m.insert("light_blue_shulker_box", 1081); m.insert("yellow_shulker_box", 1082); m.insert("lime_shulker_box", 1083);
    m.insert("pink_shulker_box", 1084); m.insert("gray_shulker_box", 1085); m.insert("light_gray_shulker_box", 1086);
    m.insert("cyan_shulker_box", 1087); m.insert("purple_shulker_box", 1088); m.insert("blue_shulker_box", 1089);
    m.insert("brown_shulker_box", 1090); m.insert("green_shulker_box", 1091); m.insert("red_shulker_box", 1092);
    m.insert("black_shulker_box", 1093);
    // Concrete powder (16 colors)
    m.insert("white_concrete_powder", 1094); m.insert("orange_concrete_powder", 1095);
    m.insert("magenta_concrete_powder", 1096); m.insert("light_blue_concrete_powder", 1097);
    m.insert("yellow_concrete_powder", 1098); m.insert("lime_concrete_powder", 1099);
    m.insert("pink_concrete_powder", 1100); m.insert("gray_concrete_powder", 1101);
    m.insert("light_gray_concrete_powder", 1102); m.insert("cyan_concrete_powder", 1103);
    m.insert("purple_concrete_powder", 1104); m.insert("blue_concrete_powder", 1105);
    m.insert("brown_concrete_powder", 1106); m.insert("green_concrete_powder", 1107);
    m.insert("red_concrete_powder", 1108); m.insert("black_concrete_powder", 1109);
    // Glazed terracotta (16 colors)
    m.insert("white_glazed_terracotta", 1110); m.insert("orange_glazed_terracotta", 1111);
    m.insert("magenta_glazed_terracotta", 1112); m.insert("light_blue_glazed_terracotta", 1113);
    m.insert("yellow_glazed_terracotta", 1114); m.insert("lime_glazed_terracotta", 1115);
    m.insert("pink_glazed_terracotta", 1116); m.insert("gray_glazed_terracotta", 1117);
    m.insert("light_gray_glazed_terracotta", 1118); m.insert("cyan_glazed_terracotta", 1119);
    m.insert("purple_glazed_terracotta", 1120); m.insert("blue_glazed_terracotta", 1121);
    m.insert("brown_glazed_terracotta", 1122); m.insert("green_glazed_terracotta", 1123);
    m.insert("red_glazed_terracotta", 1124); m.insert("black_glazed_terracotta", 1125);
    // Colored carpets (16) — already partially covered; ensure all 16
    m.insert("white_carpet", 1126); m.insert("orange_carpet", 1127); m.insert("magenta_carpet", 1128);
    m.insert("light_blue_carpet", 1129); m.insert("yellow_carpet", 1130); m.insert("lime_carpet", 1131);
    m.insert("pink_carpet", 1132); m.insert("gray_carpet", 1133); m.insert("light_gray_carpet", 1134);
    m.insert("cyan_carpet", 1135); m.insert("purple_carpet", 1136); m.insert("blue_carpet", 1137);
    m.insert("brown_carpet", 1138); m.insert("green_carpet", 1139); m.insert("red_carpet", 1140);
    ...
    m.insert("amethyst_block", 1154); m.insert("budding_amethyst", 1155);
    ...
    m.insert("azalea", 1202); m.insert("flowering_azalea", 1203);
    m.insert("big_dripleaf", 1204); m.insert("small_dripleaf", 1205);
    // Mud + mangrove
    m.insert("mud", 1206); m.insert("mud_bricks", 1207);
    m.insert("packed_mud", 1208);
    m.insert("mud_brick_stairs", 1209); m.insert("mud_brick_slab", 1210); m.insert("mud_brick_wall", 1211);
    m.insert("mangrove_roots", 1212); m.insert("muddy_mangrove_roots", 1213);
    // Sculk family
    m.insert("sculk", 1214); m.insert("sculk_vein", 1215);
    m.insert("sculk_catalyst", 1216); m.insert("sculk_shrieker", 1217);
    // Other utility
    ...
    m.insert("sulfur_stairs", 1241); m.insert("sulfur_slab", 1242);
    m.insert("polished_sulfur", 1243);
    m.insert("polished_sulfur_stairs", 1244); m.insert("polished_sulfur_slab", 1245);
    m.insert("sulfur_bricks", 1246);
    m.insert("sulfur_brick_stairs", 1247); m.insert("sulfur_brick_slab", 1248); m.insert("sulfur_brick_wall", 1249);
    ...
    m.insert("cinnabar_stairs", 1254); m.insert("cinnabar_slab", 1255);
    m.insert("polished_cinnabar", 1256);
    m.insert("polished_cinnabar_stairs", 1257); m.insert("polished_cinnabar_slab", 1258);
    m.insert("cinnabar_bricks", 1259);
    m.insert("cinnabar_brick_stairs", 1260); m.insert("cinnabar_brick_slab", 1261); m.insert("cinnabar_brick_wall", 1262);
